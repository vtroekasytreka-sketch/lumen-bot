"""Grok API client for dialog and mission synthesis."""
...
def format_history_for_grok(history: list) -> list:
    """Convert dialog history to Grok message format."""
...
async def get_lumen_response(history: list) -> dict:
    """
    Get Lumen's response from Grok API.
    ...
    """
    api_key = get_api_key()
    messages = format_history_for_grok(history)
